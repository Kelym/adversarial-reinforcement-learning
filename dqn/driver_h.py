...
dimensions = (4,4)
record_file = 'out.txt'
in_model_file = 'model_150.pth'
out_model_file = 'model_1000.pth'
...
def main():
	...
	results = agent.learn(nEpochs=1000)

	print('Saving model weights to %s' % out_model_file)
	agent.save_model(out_model_file)
